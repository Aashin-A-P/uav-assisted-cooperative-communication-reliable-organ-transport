...
hold(gx,'on');
title(gx,"Trajectory-Based AF Hopping (Map View)");
...
v = VideoWriter("AF_Trajectory_Backhaul_Map.mp4","MPEG-4");
v.FrameRate = 12;
open(v);
...
close(v);
disp("✅ Saved: AF_Trajectory_Backhaul_Map.mp4");
